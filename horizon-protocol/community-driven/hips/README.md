...
**Will there be some rules for % to pass different kind of proposal?**\
...
**Also we need to open the possibility of emergency changes in the protocol without using HIPs, how is that gonna work?**\
